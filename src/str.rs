...
mod test {
  #[cfg(feature = "alloc")]
  use crate::{branch::alt, combinator::recognize, multi::many1};
  use crate::{
  ...
  mod complete {
    use super::*;
    use crate::bytes::complete::{is_a, is_not, tag, tag_no_case, take, take_till, take_until};
  ...
  mod streaming {
    ...
    use crate::bytes::streaming::take_while as _take_while;
    use crate::bytes::streaming::take_while1 as _take_while1;

    #[test]
    fn take_while1() {
      fn f(i: &str) -> IResult<&str, &str> {
        _take_while1(is_alphabetic)(i)
      }
      let a = "";
      let b = "abcd";
      let c = "abcd123";
