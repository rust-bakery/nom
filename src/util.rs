...
pub fn error_to_u32<E>(e: &ErrorKind<E>) -> u32 {
  match *e {
    ...
    ErrorKind::Many1                     => 10,
    ErrorKind::Count                     => 11,
    ErrorKind::TakeUntilAndConsume       => 12,
    ErrorKind::TakeUntil                 => 13,
    ErrorKind::TakeUntilEitherAndConsume => 14,
    ErrorKind::TakeUntilEither           => 15,
    ErrorKind::LengthValue               => 16,
    ErrorKind::TagClosure                => 17,
    ErrorKind::Alpha                     => 18,
    ErrorKind::Digit                     => 19,
