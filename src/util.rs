...
pub fn error_to_u32<E>(e: &ErrorKind<E>) -> u32 {
  match *e {
    ...
    ErrorKind::Alpha                     => 17,
    ErrorKind::Digit                     => 18,
    ErrorKind::HexDigit                  => 19,
    ErrorKind::AlphaNumeric              => 20,
    ErrorKind::Space                     => 21,
    ErrorKind::MultiSpace                => 22,
    ErrorKind::LengthValueFn             => 23,
    ErrorKind::Eof                       => 24,
    ErrorKind::ExprOpt                   => 25,
    ErrorKind::ExprRes                   => 26,
    ErrorKind::CondReduce                => 27,
    ErrorKind::Switch                    => 28,
    ErrorKind::TagBits                   => 29,
    ErrorKind::OneOf                     => 30,
    ErrorKind::NoneOf                    => 31,
    ErrorKind::Char                      => 41,
    ErrorKind::CrLf                      => 42,
    ErrorKind::RegexpMatch               => 43,
    ErrorKind::RegexpMatches             => 44,
    ErrorKind::RegexpFind                => 45,
    ErrorKind::RegexpCapture             => 46,
    ErrorKind::RegexpCaptures            => 47,
    ErrorKind::TakeWhile1                => 48,
    ErrorKind::Complete                  => 49,
    ErrorKind::Fix                       => 50,
    ErrorKind::Escaped                   => 51,
    ErrorKind::EscapedTransform          => 52,
    ErrorKind::TagStr                    => 53,
    ErrorKind::IsNotStr                  => 54,
    ErrorKind::IsAStr                    => 55,
    ErrorKind::TakeWhile1Str             => 56,
    ErrorKind::NonEmpty                  => 57,
    ErrorKind::ManyMN                    => 58,
    ErrorKind::TakeUntilAndConsumeStr    => 59,
  }
}
